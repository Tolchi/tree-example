# -*- encoding : utf-8 -*-
# Used to generates ajax data for companies datatable.
    ...
    def fetch_companies
      ...
      if params[:sSearch].present?
        companies = companies.joins(:category).where(
          "companies.name like :search or categories.name like :search
          or direccion like :search or tel like :search or cel like :search",
